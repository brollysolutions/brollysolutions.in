      ...
      {trainer ? (
        <div className="flex items-center gap-4 p-4.5 bg-white">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[15.5px] text-slate-700 leading-relaxed mt-1 font-semibold">
  ...
  if (tl.includes("detail")) {
    ...
    return (
      <div className="bg-white border-2 border-slate-950 rounded-xl overflow-hidden shadow-sm animate-fade-in">
        ...
        <div className="p-4.5 flex flex-col gap-3 bg-white">
          {lines.map((l, idx) => (
            <div key={idx} className="flex items-start gap-3 text-[18px] text-slate-700 leading-relaxed font-normal">
